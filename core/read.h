...
class Read {
   ...
   static std::vector<std::vector<double>> loadValues(const FieldConfig& field_config_p);
   ...
   static void reorder_values(const FieldConfig& field_config, std::vector<std::vector<double>>& coords, std::vector<std::vector<double>> &values);
   static void loadNetCDFValues(const FieldConfig& field_config, std::vector<std::vector<double>>& values);
   static void loadNetCDFCoords(const FieldConfig& field_config, std::vector<std::vector<double>>& coords);
   static void loadHDF5Values(const FieldConfig& field_config, std::vector<std::vector<double>>& values);
